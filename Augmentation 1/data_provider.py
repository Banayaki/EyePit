...
def get_test_data():
    ...
    cropped_images = cropped_images1 + cropped_images2 + cropped_images3 + cropped_images4 + cropped_images1[:10]
    cropped_masks = cropped_masks1 + cropped_masks2 + cropped_masks3 + cropped_masks4 + cropped_masks1[:10]
    print(len(cropped_images))
    assert(len(cropped_images) % 32 == 0)
