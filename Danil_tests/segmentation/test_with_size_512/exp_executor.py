...
def do_cv_experiment(Xtest, Ytest, experiment_folder, exp_params_file, gen):
    ...
    trainer.set_generator(gen, iterations=570) 
...
if __name__ == "__main__":
    ...
    do_cv_experiment(Xtest, Ytest, 'exp_cv1_v16', 'exp_params.json', gen_1)

    Xtest, Ytest, gen_2 = get_data_cv2()
    do_cv_experiment(Xtest, Ytest, 'exp_cv2_v16', 'exp_params.json', gen_2)

    Xtest, Ytest, gen_3 = get_data_cv3()
    do_cv_experiment(Xtest, Ytest, 'exp_cv3_v16', 'exp_params.json', gen_3)
