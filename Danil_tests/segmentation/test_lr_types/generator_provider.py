...
from makiflow.generators.segmentation.pathgenerator import CyclicGenerator, RandomGenerator, SubCyclicGenerator
...
def get_generator(path_images, path_masks):
    ...
    return InputGenLayer(
        prefetch_size=8,
        batch_size=8, 
        path_generator=CyclicGenerator(path_images, path_masks),
        name='Input',
