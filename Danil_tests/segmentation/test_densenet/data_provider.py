...
def get_data_cv1():
    ...
    gen = get_generator(path_images='/mnt/data/med_data/balanced_batches/batch_1/train_set/aug_set/set_1024_10k_wo_4_4/10k/images',
                        path_masks='/mnt/data/med_data/balanced_batches/batch_1/train_set/aug_set/set_1024_10k_wo_4_4/10k/masks')
...
def get_data_cv2():
    ...
    gen = get_generator(path_images='/mnt/data/med_data/balanced_batches/batch_2/train_set/aug_set/set_1024_10k_wo_4_4/10k/images',
                        path_masks='/mnt/data/med_data/balanced_batches/batch_2/train_set/aug_set/set_1024_10k_wo_4_4/10k/masks')
    Xtest, _ = normalize_data(Xtest, [])
...
def get_data_cv3():
    ...
    gen = get_generator(path_images='/mnt/data/med_data/balanced_batches/batch_3/train_set/aug_set/set_1024_10k_wo_4_4/10k/images',
                        path_masks='/mnt/data/med_data/balanced_batches/batch_3/train_set/aug_set/set_1024_10k_wo_4_4/10k/masks')
