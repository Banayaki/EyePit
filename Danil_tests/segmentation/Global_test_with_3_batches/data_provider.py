...
def get_data_cv1():
    ...
    gen = get_generator(path_images='/mnt/data/med_data/balanced_batches/paper_batch_1/train_set/aug_set/set_1024_wo_4_2/images',
                        path_masks='/mnt/data/med_data/balanced_batches/paper_batch_1/train_set/aug_set/set_1024_wo_4_2/masks')
...
def get_data_cv2():
    ...
    gen = get_generator(path_images='/mnt/data/med_data/balanced_batches/paper_batch_2/train_set/aug_set/set_1024_wo_4_2/images',
                        path_masks='/mnt/data/med_data/balanced_batches/paper_batch_2/train_set/aug_set/set_1024_wo_4_2/masks')
    Xtest, _ = normalize_data(Xtest, [])
...
def get_data_cv3():
    ...
    gen = get_generator(path_images='/mnt/data/med_data/balanced_batches/paper_batch_3/train_set/aug_set/set_1024_wo_4_2/images',
                        path_masks='/mnt/data/med_data/balanced_batches/paper_batch_3/train_set/aug_set/set_1024_wo_4_2/masks')
