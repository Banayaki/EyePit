...
def get_data_cv1():
    ...
    batches_masks = []
    for i in range(8):
        path_masks, path_images = get_masks_and_images(f'/mnt/data/med_data/balanced_batches/batch_1/train_set/aug_set/set_1024_10k_wo_4_4/batches/batch_{i}')
...
def get_data_cv2():
    ...
    batches_masks = []
    for i in range(10):
        path_masks, path_images = get_masks_and_images(f'/mnt/data/med_data/balanced_batches/batch_2/train_set/aug_set/set_1024_10k_wo_4_4/batches/batch_{i}')
        batches_images.append(path_images)
        batches_masks.append(path_masks)
...
def get_data_cv3():
    ...
    batches_masks = []
    for i in range(12):
        path_masks, path_images = get_masks_and_images(f'/mnt/data/med_data/balanced_batches/batch_3/train_set/aug_set/set_1024_10k_wo_4_4/batches/batch_{i}')
        batches_images.append(path_images)
        batches_masks.append(path_masks)
