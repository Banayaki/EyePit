...
def get_data_cv2():
    ...
    masks_1, images_1 = get_masks_and_images('/mnt/data/med_data/balanced_batches/paper_batch_2/train_set/aug_set/set_1024_wo_4_3/batch_1')
    masks_2, images_2 = get_masks_and_images('/mnt/data/med_data/balanced_batches/paper_batch_2/train_set/aug_set/set_1024_wo_4_3/batch_2')
    masks_3, images_3 = get_masks_and_images('/mnt/data/med_data/balanced_batches/paper_batch_2/train_set/aug_set/set_1024_wo_4_3/batch_3')
    masks_4, images_4 = get_masks_and_images('/mnt/data/med_data/balanced_batches/paper_batch_2/train_set/aug_set/set_1024_wo_4_3/batch_4')
...
def get_data_cv3():
    ...
    masks_1, images_1 = get_masks_and_images('/mnt/data/med_data/balanced_batches/paper_batch_3/train_set/aug_set/set_1024_wo_4_3/batch_1')
    masks_2, images_2 = get_masks_and_images('/mnt/data/med_data/balanced_batches/paper_batch_3/train_set/aug_set/set_1024_wo_4_3/batch_2')
    masks_3, images_3 = get_masks_and_images('/mnt/data/med_data/balanced_batches/paper_batch_3/train_set/aug_set/set_1024_wo_4_3/batch_3')
    masks_4, images_4 = get_masks_and_images('/mnt/data/med_data/balanced_batches/paper_batch_3/train_set/aug_set/set_1024_wo_4_3/batch_4')
