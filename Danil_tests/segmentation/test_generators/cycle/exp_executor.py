...
if __name__ == "__main__":
    ...
    #do_cv_experiment(Xtest, Ytest, 'test1_cycle', 'exp_params.json', gen_1)

    #Xtest, Ytest, gen_2 = get_data_cv2()
    #do_cv_experiment(Xtest, Ytest, 'test2_cycle', 'exp_params.json', gen_2)

    Xtest, Ytest, gen_3 = get_data_cv3()
    do_cv_experiment(Xtest, Ytest, 'test3_cycle', 'exp_params.json', gen_3)
