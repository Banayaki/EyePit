...
if __name__ == "__main__":
    ...
    #do_cv_experiment(Xtest, Ytest, 'test1_random', 'exp_params.json', gen_1)

    #Xtest, Ytest, gen_2 = get_data_cv2()
    #do_cv_experiment(Xtest, Ytest, 'test2_random', 'exp_params.json', gen_2)

    Xtest, Ytest, gen_3 = get_data_cv3()
    do_cv_experiment(Xtest, Ytest, 'test3_random', 'exp_params.json', gen_3)
