...
def get_data_cv1():
    Xtest, Ytest = get_test_data(path='/mnt/data/med_data/balanced_batches/batch_1/test_set')
    
    gen = get_generator(path_images='/mnt/data/med_data/balanced_batches/batch_1/train_set/aug_set/set_1024_0/images',
                        path_masks='/mnt/data/med_data/balanced_batches/batch_1/train_set/aug_set/set_1024_0/masks')
...
def get_data_cv2():
    Xtest, Ytest = get_test_data(path='/mnt/data/med_data/balanced_batches/batch_2/test_set')
    
    gen = get_generator(path_images='/mnt/data/med_data/balanced_batches/batch_2/train_set/aug_set/set_1024_0/images',
                        path_masks='/mnt/data/med_data/balanced_batches/batch_2/train_set/aug_set/set_1024_0/masks')
    Xtest, _ = normalize_data(Xtest, [])

    return Xtest, Ytest, gen

def get_data_cv3():
    Xtest, Ytest = get_test_data(path='/mnt/data/med_data/balanced_batches/batch_3/test_set')
    
    gen = get_generator(path_images='/mnt/data/med_data/balanced_batches/batch_3/train_set/aug_set/set_1024_0/images',
                        path_masks='/mnt/data/med_data/balanced_batches/batch_3/train_set/aug_set/set_1024_0/masks')
