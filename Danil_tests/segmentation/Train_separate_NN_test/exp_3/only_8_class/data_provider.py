...
def get_data_cv1():
    Xtest, Ytest = get_test_data(path='/mnt/data/med_data/balanced_batches/batch_1/exp_3/test_set/only_8_class')
    
    gen = get_generator(path_images='/mnt/data/med_data/balanced_batches/batch_1/exp_3/train_set/only_8_class/images',
                        path_masks='/mnt/data/med_data/balanced_batches/batch_1/exp_3/train_set/only_8_class/masks')
...
def get_data_cv2():
    Xtest, Ytest = get_test_data(path='/mnt/data/med_data/balanced_batches/batch_2/exp_3/test_set/only_8_class')
    
    gen = get_generator(path_images='/mnt/data/med_data/balanced_batches/batch_2/exp_3/train_set/only_8_class/images',
                        path_masks='/mnt/data/med_data/balanced_batches/batch_2/exp_3/train_set/only_8_class/masks')
    Xtest, _ = normalize_data(Xtest, [])

    return Xtest, Ytest, gen

def get_data_cv3():
    Xtest, Ytest = get_test_data(path='/mnt/data/med_data/balanced_batches/batch_3/exp_3/test_set/only_8_class')
    
    gen = get_generator(path_images='/mnt/data/med_data/balanced_batches/batch_3/exp_3/train_set/only_8_class/images',
                        path_masks='/mnt/data/med_data/balanced_batches/batch_3/exp_3/train_set/only_8_class/masks')
