...
if __name__ == "__main__":
    ...
    do_cv_experiment(Xtest, Ytest, 'exp_cv3_l2_v13', 'exp_params.json', gen_1)

    Xtest, Ytest, gen_2 = get_data_cv2()
    do_cv_experiment(Xtest, Ytest, 'exp_cv4_l2_v13', 'exp_params.json', gen_2)

    Xtest, Ytest, gen_3 = get_data_cv3()
    do_cv_experiment(Xtest, Ytest, 'exp_cv5_l2_v13', 'exp_params.json', gen_3)
