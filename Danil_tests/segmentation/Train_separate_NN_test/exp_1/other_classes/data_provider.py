...
def get_data_cv1():
    Xtest, Ytest = get_test_data(path='/mnt/data/med_data/balanced_batches/batch_1/exp_1/test_set/other_classes')
    
    gen = get_generator(path_images='/mnt/data/med_data/balanced_batches/batch_1/exp_1/train_set/other_classes/images',
                        path_masks='/mnt/data/med_data/balanced_batches/batch_1/exp_1/train_set/other_classes/masks')
...
def get_data_cv2():
    Xtest, Ytest = get_test_data(path='/mnt/data/med_data/balanced_batches/batch_2/exp_1/test_set/other_classes')
    
    gen = get_generator(path_images='/mnt/data/med_data/balanced_batches/batch_2/exp_1/train_set/other_classes/images',
                        path_masks='/mnt/data/med_data/balanced_batches/batch_2/exp_1/train_set/other_classes/masks')
    Xtest, _ = normalize_data(Xtest, [])

    return Xtest, Ytest, gen

def get_data_cv3():
    Xtest, Ytest = get_test_data(path='/mnt/data/med_data/balanced_batches/batch_3/exp_1/test_set/other_classes')
    
    gen = get_generator(path_images='/mnt/data/med_data/balanced_batches/batch_3/exp_1/train_set/other_classes/images',
                        path_masks='/mnt/data/med_data/balanced_batches/batch_3/exp_1/train_set/other_classes/masks')
